...
data.basenodes.travel = {
	...
	"Dread Wastes,75.4,21.3 <tag:pandarope> -x- Vale of Eternal Blossoms,14.2,76.8 <tag:pandarope> (B:PORTAL)", -- (click the Climbing Rope to either climb up or jump down the cliff)
