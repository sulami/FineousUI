...
ZygorGuidesViewer_L("Main", "enUS", function() return {
	...
	["opt_group_talentsystem_desc"] = "Suggests which talents you should invest your talent points in, for you to play optimally.",
		...
		['opt_talenticon'] = "Show the icons",
		['opt_talenticon_desc'] = "Show the talent icons to indicate Zygor's suggested talents and specializations.",
	...
	["opt_group_waypointer_desc"] = "The internal map node display and waypointing system.",
...
If you're new to the guides, or have only started using them on this character, you can use the |cffddff00Smart Injection System|r to automatically find a proper starting spot for you. It might turn out to be far below your current level, if you skipped some useful quest chains or flight points, but the guide will catch up once you complete them.",
	...
	['opt_group_mapinternal'] = "Internal waypointer",
		...
		['opt_colorantsother'] = "Ground",				['opt_colorantsother_desc'] = "This color will be used for ground travel",
	...
	['opt_group_conv'] = "Extra features",			['opt_group_conv_desc'] = "Various things that we thought might be useful.",
		...
		['opt_autoaccept'] = "Accept quests",					['opt_autoaccept_desc'] = "Automatically accept quests, if the current step instructs you to.\n|cffffaa88This makes questing very fast, but may be confusing.",
		['opt_autoturnin'] = "Turn in quests",					['opt_autoturnin_desc'] = "Automatically turn in quests, if the current step instructs you to.\nWorks only if there is no reward to choose.\n|cffffaa88This makes questing very fast, but may be confusing.",
		...
		['opt_fixblizzardautoaccept'] = "'Fix' built-in auto-accepting",	['opt_fixblizzardautoaccept_desc'] = "Since patch 3.2, quests for levels 1-3 get automatically accepted, but the quest window stays open, which confuses some players.\nThis option changes the 'Accept' button into 'Accepted' to make it feel more natural.",
		['opt_item'] = "Items",							['opt_item_desc'] = "Set the different features that deal with items.",
		['opt_loot'] = "Vendors",
		['opt_autosell'] = "Automatically sell grey items",			['opt_autosell_desc'] = "Automatically sells grey items when a vendor window is opened.\n|cffffaa88Will sell all grey items in inventory.",
		['opt_autobuy'] = "Automatically buy items",				['opt_autobuy_desc'] = "Automatically buy the items in the current step of your guide when the vendor is opened.\n|cffffaa88Will not buy any items if you don't have enough money for all of them.",
		...
		['opt_showmoneyframe'] = "Show value of greys",				['opt_showmoneyframe_desc'] = "Show window to view value of current grey items.",
		['opt_gear'] = "Equipment",
		...
		['opt_clearnotupgrades'] = "Clear not upgrades",			['opt_clearnotupgrades_desc'] = "Clear the list of items that are not checked for upgrades because either your current item is better, or you declined an upgrade.\n|cffffaa88Clearing this will not cause any problems, but will cause confirm box to pop up on previously declined items.",
		...
		['opt_collapsecompleted'] = "Hide completed groups",		['opt_collapsecompleted_desc'] = "Hides completed goals together with the lines 'above' them in the step, following indentation order.|n|nWorks best with long, multiple-objective steps.|n|n|cffff3300Experimental feature.|r",
...
--]]
	...
	['static_dungeon'] = "Would you like to load the guide:\n\n%s",
	['static_dungeondontshow'] = "Don't ask again for this dungeon.",
	['static_dungeonaccept'] = "Accept",
	['static_dungeondecline'] = "Decline",
