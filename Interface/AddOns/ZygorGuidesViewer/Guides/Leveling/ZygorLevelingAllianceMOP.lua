...
step
goto 48.6,20.5
.click Shattered Simulacrum##11370
..accept 29748
step
goto 48.1,18.1
...
..accept 29929
step
.' Go down the wood ramp here. |goto 45.2,29.2 |c
step
goto 44.1,31.4
...
step
.' Leave the mine. |got 45.9,28.82 |c
step
goto 46.3,29.4
.talk 56467
..turnin 29929
...
step
goto 58.2,61.4
.click Playful Crimson Serpent##56852
...
step
goto 56.5,58.4
.click Playful Emerald Serpent##56851
...
step
goto 85.1,32.52
.click Stolen Watermelon
.' get 5 Stolen Watermelon##76298+ |q 29940/2
step
goto 81.6,25.2
.talk 56207
..turnin 29940
...
step
goto 66.5,41.7
.from Longfang Howler##56524+, Mushan Nomad##56523+, Tawnyhide Stag##56532+, Tawnyhide Doe##56531+, Tawnyhide Fawn##56526+
...
.kill 8 Mutated Silkworm##59002+ |q 30059/2
step
goto 63.5,58.5
.talk 57424
..turnin 30059
...
..accept 30049
step
goto Valley of the Four Winds 53.8,50.9
.talk 60231
.fpath Halfhill
step
goto 54.3,38.7
...
.talk 58821
..turnin 30445
// This wasn't in the guide when I checked -		..accept 30360
step
...
//Tomb of Conquerors, Need Caveman
step
...
step
'Exit the cave |goto 52.9,71.3 <5 |c
step
goto 52.0,67.3
.talk 59452
..turnin 30599
...
|confirm
step
'Protect the caravan and escort them to this point |goto 43.9,68.9 <5 |c
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Loremaster Guides\\Pandaria 85-90\\Krasarang Wilds (87)",[[
step
...
..turnin 30672
step
'Hearth to the Sentinel Basecamp |goto Krasarang Wilds 25.5,33.2  <5 |use Hearthstone##6948 |noway |c
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Loremaster Guides\\Pandaria 85-90\\Valley of the Four Winds (86)",[[
step
goto Valley of the Four Winds 19.5,56.8
.talk 56720
..turnin 30360
