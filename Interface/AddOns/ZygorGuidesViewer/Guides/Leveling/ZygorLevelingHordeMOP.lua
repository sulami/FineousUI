...
// NPC ID
goto 30.6,7.1
.' Talk Ellie Honeypaw//##1124
..accept 31772
step
goto 33.1,10.6
.kill 20 Sha Haunt |q 31771/1
.kill 7 Sh Harbinger |q 31771/2
step
goto 30.5,7.2
.talk 55146
...
// Need NPC ID
goto 29.2,9.0
.' Kill Sha-Infested Prowlers |q 31773/1
.click Barrel of Honeydew |q 31772/1
...
// NPC FIX
goto 29.4,13.6
.' Talk Ellie Honeypaw//##1312
..turnin 31772
step
// NPC FIX
goto 29.1,13.7
.' Talk Sergeant Gorrok//##1309
..turnin 29694
step
// NPC FIX
goto 29.2,13.8
.' Talk Mayor Honeydew//##684
..turnin 31770
step
// NPC FIX
goto 29.1,13.8
...
.get Zin'Jun's Rifle 29765 |q 29765/1
.get Zin'Jun's Left Eye |q 29765/2
.get Zin'Jun's Right Eye |q 29765/3
.get Snuff's Corpse |q 29765/4
step
...
step
goto 31.7,21.9
.' Talk General Nazgrim//##463
..turnin 29804
..accept 31775
..accept 31776
step
goto The Jade Forest 31.4,21.8
.' Talk Merchant Zin//##462
..accept 31778
step
goto 31.1,21.6
.talk 55521
...
step
goto 29.7,23.7
.kill Morgus Grimhatchet |q 31776/2
.' He walks around the area.
step
goto 27.8,23.1
.kill Corporal Jackson Silver |q 31776/3
step
goto 28.3,24.6
.' Talk Pandaren Volunteer//##1554
.' Tell them that they can leave.
.' Free 12 Pandaren |q 31778/1
.click Requisitioned Firework Launcher##11158
...
..kill 12 Strongarm Gyrocopter shot down |q 31777/1
..kill Strongarm Troops |q 31775/1
step
goto 31.1,21.6
.talk 55521
..turnin 31777		
...
.kill 50 Hozen Gutripper##55707 |q 29827/1
.kill 50 Hozen Nibstabber##55701 |q 29827/2
step
goto 28.2,24.8
.talk 55180
..turnin 29827
...
.' Kill the Bloodthirsty Saurok that spawns.
...
.' Kill 30 Jinyu Attackers |q 29967/1
step
goto The Jade Forest 29.0,49.1
.talk 56525
..turnin 29967
...
.talk The Jade Forest 58.1,59.0
..accept 29999
..accept 30005
step
...
step
goto 28.1,47.4
.click Bucket of Slicky Water |q 30466/2
step
goto The Jade Forest 28.4,47.8
.talk 59305
.' Tell him Nazgrims needs an update |q 30484/2
step
...
.kill 8 Tiny Mutated Silkmoth |q 30059/2
step
goto Valley of the Four Winds 63.5,58.5
.talk 57424
..turnin 30059
...
|fly Grassy Cline
step
goto Krasarang Wilds 76.4,7.7 |n
.' Follow the path to find Ken-Ken. |goto Krasarang Wilds 76.4,7.7 <5 |c
]])
...
..accept 30935
step
'Exit the Tomb of Conquerors |goto 53.0,46.5 <5 |c
step
goto 53.0,46.4
.talk 61382
...
.' Use your Totem of Harmony on Crazed Shado-Pan Rangers
...
..accept 30980
step
'Follow the path down |goto 54.2,85.3 <5 |c
step
goto 51.8,85.2
