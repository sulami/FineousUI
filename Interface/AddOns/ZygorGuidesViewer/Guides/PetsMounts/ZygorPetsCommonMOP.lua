...
description the Beast pet: Alpine Foxling
condition end haspet(63550)
pet 724
step
...
//Tradeable = false
description This guide will walk you through obtaining
description the Beast pet: Alpine Foxling Kit
condition end haspet(63551)
pet 725
step
...
//Caught in wild = true
//Source = Pet Battle: Dread Wastes Pet Battle: Townlong Steppes
//Can Battle = true
//Tradeable = false
description This guide will walk you through obtaining
description the Flying pet: Amber Moth
condition end haspet(65187)
pet 732
step
...
//Caught in wild = true
//Source = Pet Battle: Valley of Four Winds
//Can Battle = true
//Tradeable = false
description This guide will walk you through obtaining
description the Flying pet: Amorous Rooster
condition end haspet(65029)
pet 705
step
...
//Source = Drop: Nalash Verdantis Zone: Dread Wastes
//Can Battle = true
//Tradeable = true
description This guide will walk you through obtaining
description the Aquatic pet: Aqua Strider
condition end haspet(64633)
pet 836
step
...
//Caught in wild = true
//Source = Pet Battle: Dread Wastes
//Can Battle = true
//Tradeable = false
description This guide will walk you through obtaining
description the Beast pet: Clouded Hedgehog
condition end haspet(64242)
pet 742
step
...
condition end haspet(61088)
pet 383
step
goto Vale of Eternal Blossoms 69.9,30.0
.' The _Eternal Striders_ are around level 24. Challenge one to a pet battle and capture it.
...
//Caught in wild = true
//Source = Pet Battle: Jade Forest
//Can Battle = true
//Tradeable = false
description This guide will walk you through obtaining
description the Flying pet: Garden Moth
condition end haspet(65215)
pet 753
step
...
//Caught in wild = false
//Source = Drop: Karr the Darkener Zone: Dread Wastes
//Can Battle = true
//Tradeable = true
description This guide will walk you through obtaining
description the Elemental pet: Grinder
condition end haspet(64634)
pet 834
step
...
//Caught in wild = true
//Source = Pet Battle: The Jade Forest, The Jade Forest
//Can Battle = true
//Tradeable = false
description This guide will walk you through obtaining
description the Beast pet: Grove Viper
condition end haspet(63004)
pet 571
step
...
//Caught in wild = false
//Source = Reward: Sho: Exalted
//Can Battle = true
//Tradeable = false
description This guide will walk you through obtaining
description the Critter pet: Red Cricket
condition end haspet(63370)
pet 1042
step
...
//Caught in wild = false
//Source = Drop: World Drop Zone: Valley of the Four Winds
//Can Battle = true
//Tradeable = true
description This guide will walk you through obtaining
description the Elemental pet: Terrible Turnip
condition end haspet(63365)
pet 650
step
'Go to _Valley of the Four Winds_ |goto Valley of the Four Winds |noway |c
step
'_Kill_ any and all mobs in _Valley of the Four Winds_ |tip Every mob here has a chance to drop the Terrible Turnip
.collect 1 Terrible Turnip##85220
|modeldisplay 44655
step
...
//Caught in wild = true
//Source = Pet Battle:  Krasarang Wilds Event:  Wanderer's Festival
//Can Battle = true
//Tradeable = true
description This guide will walk you through obtaining
description the Aquatic pet: Wanderer's Festival Hatchling
condition end haspet(67022)
//pet 1013
step
...
//Caught in wild = true
//Source = Pet Battle: The Jade Forest Faction: Order of the Cloud Serpent (Exalted)
//Can Battle = true
//Tradeable = false
description This guide will walk you through obtaining
description the Dragonkin pet: Wild Crimson Hatchling
condition end haspet(65321)
pet 819
step
...
//Caught in wild = true
//Source = Pet Battle: Townlong Steppes Pet Battle: Dread Wastes
//Can Battle = true
//Tradeable = false
description This guide will walk you through obtaining
description the Critter pet: Yakrat
condition end haspet(63957)
pet 740
step
